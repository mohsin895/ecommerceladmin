<template>
    <div class="product-list">
        ...
        <div class="add-slider">
            <router-link :to="{name:'SliderAdd'}" class="add-btn">Add New Slider</router-link>
        </div>
        <br>
            ...
            <table class="table table-bordered">
                 ...
                 <slot v-for="(dataInfo,index) in dataList.data">
                    <tr>
                      ...
                      <td>
                      	<img v-lazy="dataInfo.base_url+dataInfo.slider_url" :alt="dataInfo.name" height="70" width="70">
                      </td>
                      <td>{{dataInfo.title}}</td>
                      <td>
                      	<a :href="dataInfo.target_url" target="_blank" class="badge bg-info text-light">{{dataInfo.target_url}}</a>
                      </td>
                      ...
                      <td>
          			           <router-link :to="{name:'SliderEdit',params:{dataId:dataInfo.id}}" class="btn btn-warning btn-sm text-light">
...
export default{
    ...
    methods:{
        ...
        async changeDataStatus(dataId,status){
            ...
            await this.$http.post('/slider/change/status',formData,config)
                 .then(response=>{
