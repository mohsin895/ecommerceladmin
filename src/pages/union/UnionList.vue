<template>
    <div class="product-list">
        ...
        <br>
        <div class="add-union">
            <router-link :to="{name:'UnionAdd'}" class="add-btn">Add New Union</router-link>
        </div>
        <br>
            ...
            <table class="table table-bordered">
                 ...
                 <slot v-for="(dataInfo,index) in dataList.data">
                    <tr>
                      ...
                      <td>{{dataInfo.name}}</td>
                      <td>{{dataInfo.bn_name}}</td>
                      <td>
                        <slot v-if="dataInfo.thana_info!=null">
                          {{dataInfo.thana_info.name}}
                        </slot>
                      </td>
                      <td>
                        <slot v-if="dataInfo.thana_info!=null">
                          <slot v-if="dataInfo.thana_info.district_info!=null">
                            {{dataInfo.thana_info.district_info.name}}
                          </slot>
                        </slot>
                      </td>
                      <td>
                        <slot v-if="dataInfo.thana_info!=null">
                          <slot v-if="dataInfo.thana_info.district_info!=null">
                            <slot v-if="dataInfo.thana_info.district_info.division_info!=null">
                              {{dataInfo.thana_info.district_info.division_info.name}}
                            </slot>
                          </slot>
                        </slot>
                      </td>
                      ...
                      <td>
                           <router-link :to="{name:'UnionEdit',params:{dataId:dataInfo.id}}" class="btn btn-warning btn-sm text-light">
...
export default{
    ...
    methods:{
        ...
        async changeDataStatus(dataId,status){
            ...
            await this.$http.post('/union/change/status',formData,config)
                 .then(response=>{
