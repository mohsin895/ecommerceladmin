<template>
    <div class="product-list">
        ...
        <br>
        <div class="add-color">
            <router-link :to="{name:'ColorAdd'}" class="add-btn">Add New color</router-link>
        </div>
        <br>
            ...
            <table class="table table-bordered">
                 ...
                 <slot v-for="(dataInfo,index) in dataList.data">
                    <tr>
                      ...
                      <td>
                        <span class="badge" :style="{backgroundColor:dataInfo.color_code}">{{dataInfo.color}}</span>
                      </td>
                      <td>
                        <span class="badge" :style="{backgroundColor:dataInfo.color_code}">{{dataInfo.color_code}}</span>
                      </td>
                      ...
                      <td>
      			           <router-link :to="{name:'ColorEdit',params:{dataId:dataInfo.id}}" class="btn btn-warning btn-sm text-light">
...
export default{
    ...
    methods:{
        ...
        async changeDataStatus(dataId,status){
            ...
            await this.$http.post('/color/change/status',formData,config)
                 .then(response=>{
