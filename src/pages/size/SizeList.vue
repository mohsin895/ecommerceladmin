<template>
    <div class="product-list">
        ...
        <br>
        <div class="add-size">
            <router-link :to="{name:'SizeAdd'}"class="add-btn">Add New size</router-link>
        </div>
        <br>
            ...
            <table class="table table-bordered">
                 ...
                 <slot v-for="(dataInfo,index) in dataList.data">
                    <tr>
                      ...
                      <td>
                        <span class="badge bg-success h6">{{dataInfo.size}}</span>
                      </td>
                      ...
                      <td>
          			           <router-link :to="{name:'SizeEdit',params:{dataId:dataInfo.id}}" class="btn btn-warning btn-sm text-light">
...
export default{
    ...
    methods:{
        ...
        async changeDataStatus(dataId,status){
            ...
            await this.$http.post('/size/change/status',formData,config)
                 .then(response=>{
