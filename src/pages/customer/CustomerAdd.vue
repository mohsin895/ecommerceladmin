<template>
	<div class="card border-secondary  mb-3" >
	  <div class="card-header h4">Customer Add</div>
	  <div class="card-body ">
	    <form @submit.prevent="formSubmitPrevent()">
	    	<div class="row">
	    		...
	    		<div class="col-12 mt-2 d-flex flex-row-reverse">
	    			...
	    			<button class="btn btn-info m-2 text-light" @click="addCustomer">
	...
	methods:{
    			...
    			this.errMsgFlag=false;
		    		...
		    		let token=window.localStorage.getItem("token");
					 let config = {
			         	...
			         	this.$http.post("customer/add",formData,config)
			         		.then(response=>{
    	...
    	formValidation()
    	{
    		if( this.name!=null && this.phone!=null )
    		{
				...
				if(this.phone==null)
				{
					this.errMsg="Please Select Customer Phone Number.";
					this.$toaster.warning(this.errMsg);
				}
