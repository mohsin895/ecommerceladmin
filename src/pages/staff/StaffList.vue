<template>
    <div class="product-list">
        ...
        <br>
        <div class="add-staff">
            <router-link :to="{name:'StaffAdd'}" class="add-btn">Add New Staff</router-link>
        </div>
        <br>
            ...
            <table class="table table-bordered">
                 ...
                 <slot v-for="(dataInfo,index) in dataList.data">
                    <tr>
                      ...
                      <td>
          			           <router-link :to="{name:'StaffEdit',params:{dataId:dataInfo.id}}" class="btn btn-warning btn-sm text-light">
...
export default{
    ...
    methods:{
        ...
        async changeDataVerifyStatus(dataId,status){
            ...
            await this.$http.post('/staff/verify',formData,config)
                 .then(response=>{
        ...
        async changeDataStatus(dataId,status){
            ...
            await this.$http.post('/staff/change/status',formData,config)
                 .then(response=>{
                    this.errMsgFlag=response.data.errMsgFlag;
                    this.msgFlag=response.data.msgFlag;
                    this.msg=response.data.msg;
