<template>
    <div class="product-list">
        ...
        <div class="add-banner">
            <router-link :to="{name:'BannerAdd'}" class="add-btn">Add New Banner</router-link>
        </div>
        <br>
            ...
            <table class="table table-bordered">
                 ...
                 <slot v-for="(dataInfo,index) in dataList.data">
                    <tr>
                      ...
                      <td>
                      	<img v-lazy="dataInfo.base_url+dataInfo.banner_url" :alt="dataInfo.name" height="70" width="70">
                      </td>
                      <td>{{dataInfo.title}}</td>
                      <td>
                      	<slot v-if="dataInfo.category_info!=null">
                      		{{dataInfo.category_info.title}}
                      	</slot>
                      </td>
                      ...
                      <td>
          			           <router-link :to="{name:'BannerEdit',params:{dataId:dataInfo.id}}" class="btn btn-warning btn-sm text-light">
...
export default{
    ...
    methods:{
        ...
        async changeDataStatus(dataId,status){
            ...
            await this.$http.post('/banner/change/status',formData,config)
                 .then(response=>{
