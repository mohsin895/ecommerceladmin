<template>
    <div class="product-list">
        ...
        <div class="add-district">
            <router-link :to="{name:'DistrictList'}" class="add-btn">Add New District</router-link>
        </div>
        <br>
            ...
            <table class="table table-bordered">
                 ...
                 <slot v-for="(dataInfo,index) in dataList.data">
                    <tr>
                      ...
                      <td>
                        <slot v-if="dataInfo.division_info!=null">
                          {{dataInfo.division_info.name}}
                        </slot>
                      </td>
                      ...
                      <td>
                           <router-link :to="{name:'DistrictEdit',params:{dataId:dataInfo.id}}" class="btn btn-warning btn-sm text-light">
...
export default{
    ...
    methods:{
        ...
        async changeDataStatus(dataId,status){
            ...
            await this.$http.post('/district/change/status',formData,config)
                 .then(response=>{
