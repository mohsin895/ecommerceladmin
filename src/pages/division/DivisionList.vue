<template>
    <div class="product-list">
        ...
        <div class="add-division">
            <router-link :to="{name:'DivisionAdd'}" class="add-btn">Add New Division</router-link>
        </div>
        <br>
            ...
            <table class="table table-bordered">
                 ...
                 <slot v-for="(dataInfo,index) in dataList.data">
                    <tr>
                      ...
                      <td>
          			           <router-link :to="{name:'DivisionEdit',params:{dataId:dataInfo.id}}" class="btn btn-warning btn-sm text-light">
...
export default{
    ...
    methods:{
        ...
        async changeDataStatus(dataId,status){
            ...
            await this.$http.post('/division/change/status',formData,config)
                 .then(response=>{
