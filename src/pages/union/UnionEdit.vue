<template>
	<div class="card border-secondary  mb-3" >
	  <div class="card-header h4">Union Add</div>
	  <div class="card-body ">
	    	...
	    	<div class="row">
	    		...
	    		<div class="col-6">
	    			<div class="form-group mt-2">
					    ...
					    <v-select :options="thanaList" :reduce="thanaList => thanaList.id" label="name" v-model="thana" >
					  ...
					  <div class="form-group mt-2">
					    <label for="title">Union Name</label>
	    		...
	    		<div class="col-12 mt-2 d-flex flex-row-reverse">
	    			...
	    			<button class="btn btn-info m-2 text-light" @click="addUnion()">
...
export default{
	...
	methods:{
		getThanaList(){
				...
				this.$http.get("thana/get/active/list")
					.then(response=>{
    			...
    			this.errMsgFlag=false;
		    		...
		    		let token=window.localStorage.getItem("token");
					 let config = {
			         	...
			         	this.$http.post("union/add",formData,config)
			         		.then(response=>{
    	...
    	formValidation()
    	{
    		if(this.name!=null && this.bn_name!=null && this.thana!=null)
    		{
    			return true;
    		}
    		else{
				...
				if(this.name==null)
				{
					this.errMsg="Please Enter Union Name.";
					this.$toaster.warning(this.errMsg);
				}
				if(this.bn_name==null)
				{
					this.errMsg="Please Enter Union Bangla Name.";
					this.$toaster.warning(this.errMsg);
				}
				if(this.division==null)
				{
					this.errMsg="Please Select A Thana";
					this.$toaster.warning(this.errMsg);
				}
